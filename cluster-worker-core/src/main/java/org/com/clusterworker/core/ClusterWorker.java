...
import org.com.clusterworker.core.consumer.HazelcastCallableConsumer;
...
import org.com.clusterworker.core.producer.quartz.HazelcastCallableProducerSubmitter;
import org.com.clusterworker.core.producer.quartz.HazelcastCallableProducerSubmitterDetail;
import org.com.clusterworker.core.support.AnnotationSupport;
import org.com.clusterworker.core.support.HazelcastSupport;
import org.com.clusterworker.core.support.ItemSupport;
import org.com.clusterworker.core.support.QuartzPropertySupport;
...
public final class ClusterWorker<T> {
     ...
     * @throws ItemProcessorException if there is any error to execute this {@link ItemProcessorException}
     * @since 1.0.0
     */
     ...
     * @throws ItemProducerException if there is any error to execute this {@link ItemProducer}
     * @since 1.0.0
     */
    ...
    public boolean isDone(ItemProcessor<T> itemProcessor) {
    	...
    	if (this.processors.containsKey(itemProcessor)) {
			isDone = this.processors.get(itemProcessor).stream().allMatch(Future::isDone);
		}
